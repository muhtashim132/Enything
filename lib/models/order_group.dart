...
class OrderGroup {
  ...
  double get totalEarnings =>
      orders.fold(0.0, (sum, o) => sum + o.riderEarnings);
  ...
  String? get customerName => orders.first
      .customerId; // actually we don't store customer name in order model?
  ...
  bool get allPickedUp => orders.every((o) =>
      ...
      o.status == 'delivered');
  bool get allOutForDelivery => orders
      .every((o) => o.status == 'out_for_delivery' || o.status == 'delivered');
