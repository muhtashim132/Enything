...
if __name__ == "__main__":
    pad_image("logo/Enything_backup.png", "logo/Enything_backup_padded.png", 1.55)
    pad_image("logo/Enything_backup.png", "logo/Enything_backup_splash.png", 2.20) # Made this one even smaller for splash
