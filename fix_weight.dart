...
void main() async {
  ...
  final inputFile = fs.file(r'e:\Enything\supabase\migrations\20271125000007_100x_critical_bug_fixes.sql');
...
''' + funcContent + '\n';
  ...
  final outputFile = fs.file(r'e:\Enything\supabase\migrations\20271125000008_100x_unit_type_weight_fix.sql');
