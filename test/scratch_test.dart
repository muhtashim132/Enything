...
Future<void> main() async {
  ...
  await client.auth.signInWithPassword(
      email: '${sellerPhone.replaceAll('+', '')}@enything.com',
      password: sellerPhone.replaceAll('+', ''));
  ...
  await client.auth.signInWithPassword(
      email: '${customerPhone.replaceAll('+', '')}@enything.com',
      password: customerPhone.replaceAll('+', ''));
  ...
  var prod = await client
      .from('products')
      .select('total_quantity, is_available')
      .eq('id', productId)
      .single();
