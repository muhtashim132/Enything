-- =============================================================================
-- Migration: Secure Checkout Transaction Validation
-- Description: Replaces place_orders_transaction with strict server-side validation
-- to prevent price spoofing. Validates item prices against DB and enforces
-- mathematical correctness of order totals.
-- =============================================================================
