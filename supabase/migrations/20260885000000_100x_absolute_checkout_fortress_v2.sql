-- =============================================================================
-- Phase 30: Absolute Fortress v2 (Negative Math Exploits & Final Pixel Bounds)
-- Description: Enforces strict < 0.0 checks on all incoming fee fields to prevent
-- negative value math exploits (Zero-Fee theft). Adds final string bounds to 
-- razorpay fields and variant_name to completely seal off OOM pixel overloading.
-- =============================================================================
