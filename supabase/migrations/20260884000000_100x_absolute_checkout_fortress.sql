-- =============================================================================
-- Phase 29: Absolute Fortress (String Payload Bloat & Admin Sanity Bounds)
-- Description: Enforces hard limits on string lengths (address, notes, etc.) to 
-- prevent pixel overloading / OOM crashes, and adds LEAST/GREATEST clamps to all 
-- dynamic admin configurations (GST, commissions) to prevent mathematical crashes 
-- and fund draining caused by admin typos.
-- =============================================================================
