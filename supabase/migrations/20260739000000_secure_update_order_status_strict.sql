-- =============================================================================
-- Migration: Secure Update Order Status Strict
-- Description: 
-- Prevents arbitrary users from setting unhandled states like 'cancelled'
-- through the update_order_status RPC by enforcing a strict allowlist
-- of statuses.
-- =============================================================================
