-- =============================================================================
-- Migration: 20290000000080_100x_fix_terminal_order_and_replacement_fees.sql
-- =============================================================================
-- Description:
--   1. Fixes "Cannot change status of a terminal order (seller_rejected) to cancelled":
--      When p_order_id_to_cancel is already in a terminal state (seller_rejected / partner_rejected),
--      do NOT update status to 'cancelled' (which triggers the state machine error). Only update
--      cancelled_reason, refund_status, and updated_at.
--   2. Supports additive replacement orders where cart_group_id has existing active orders.
-- =============================================================================
