-- =============================================================================
-- Migration: 20271125000012_100x_checkout_coupon_increment_fix.sql
-- Description: ADDITIVE ONLY - CREATE OR REPLACE FUNCTION only.
--              Fixes a logic failure where coupon usage counts were not
--              incremented because an EXISTS check was inappropriately checking
--              if orders with the new cart group ID already existed (which they
--              always do, since they were inserted lines prior).
-- =============================================================================
