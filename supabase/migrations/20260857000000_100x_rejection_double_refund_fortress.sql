-- =============================================================================
-- Migration: 100x Rejection Double Refund Fortress (Phase 4)
-- Description:
--   1. Fixes a Critical Financial Double-Refund Exploit where the `refund_status` 
--      was blindly overwritten to 'processing' even if an admin had already 
--      manually refunded the order ('completed').
-- =============================================================================
