-- =============================================================================
-- Migration: 100x Coupon Checkout Crash Fix
-- Description:
--   1. Fixes Critical Coupon Checkout Outage: Replaces the hallucinated 
--      `decrements` CTE insert statement in `place_orders_transaction` with 
--      the correct, physical `UPDATE coupons` statement, restoring the 
--      entire coupon checkout flow.
-- =============================================================================
...
BEGIN
  ...
  -- 100x FIX: Restored the physical UPDATE coupons statement instead of the hallucinated CTE insert
  IF p_coupon_id IS NOT NULL THEN
