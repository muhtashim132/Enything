-- Migration 20260869000000_100x_extreme_edge_fortress.sql
-- Fixes Phase 16: The Extreme Edge Cases (Pixel Overload, Negative Smuggling, Coupon Spoofing)
...
BEGIN
  ...
  IF p_coupon_id IS NOT NULL THEN
    ...
    IF p_order_id_to_cancel IS NULL THEN
      ...
      -- 100x STRESS TEST FIX: Coupon Global State Validation
