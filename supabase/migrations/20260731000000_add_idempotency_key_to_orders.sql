-- =============================================================================
-- Migration: Add idempotency key to orders table
-- Description:
--   1. Adds an idempotency_key column to the orders table.
--   2. Adds a UNIQUE constraint on (idempotency_key) to prevent duplicate orders.
--   3. Updates the place_orders_transaction RPC to accept and store the key.
-- =============================================================================
