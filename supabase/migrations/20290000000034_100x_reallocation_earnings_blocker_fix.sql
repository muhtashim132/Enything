-- =============================================================================
-- Migration: 100x Reallocation Earnings Blocker Fix
-- Description:
--   Permanently removes the `AND COALESCE(rider_earnings, 0) = 0` condition 
--   from `reallocate_cancelled_delivery_fees` that was accidentally reintroduced
--   in Migration 32. Since rider earnings are calculated and saved at order 
--   placement for multi-shop orders, this condition prevented the function 
--   from ever finding any cancelled orders, completely paralyzing fee reallocation.
-- =============================================================================
