-- =============================================================================
-- Migration: 20290000000036_100x_remove_hardcoded_radius_caps.sql
-- Description: Removes the hardcoded 50km/100km caps from geospatial search 
--              functions to fully respect the admin panel's max_delivery_radius_km.
