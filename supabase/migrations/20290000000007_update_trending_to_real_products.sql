-- ============================================================================
-- Migration: 20271126000000_update_trending_to_real_products.sql
-- Description: ADDITIVE ONLY — Updates get_trending_keywords to fetch real 
--              product names from the database within the admin radius,
--              sorted by sales count. Fallback to just available products.
-- ============================================================================
