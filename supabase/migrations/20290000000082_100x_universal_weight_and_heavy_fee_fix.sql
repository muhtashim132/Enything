-- =============================================================================
-- Migration: 20290000000082_100x_universal_weight_and_heavy_fee_fix.sql
-- =============================================================================
-- Description:
--   1. Fixes unit normalization in place_orders_transaction so grams/ml/mg
--      entered by sellers (e.g. 500ml Mojito, 200g Momo, 500g Jeans) are correctly
--      converted to Kilograms in SQL, matching WeightEngine.
--   2. Prevents false positive 'Heavy order fee spoofing detected' exceptions
--      when orders are below the 10kg heavy order threshold.
--   3. Synchronizes heavy order fee validation between per-kg and flat rate models.
-- =============================================================================
