-- Migration 20260848000000_100x_atomic_swap_reallocate.sql
-- Fixes cascading logic failure where stranded delivery fees were not reallocated before rebalancing during atomic swaps.
