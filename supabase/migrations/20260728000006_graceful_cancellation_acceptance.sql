-- =============================================================================
-- Migration: Graceful Cancellation Handling for Acceptances
-- Description: Modifies accept_order_seller and accept_order_rider to throw
-- a specific 'ORDER_CANCELLED' exception if the customer cancelled the order
-- while the acceptance was in progress.
-- =============================================================================
