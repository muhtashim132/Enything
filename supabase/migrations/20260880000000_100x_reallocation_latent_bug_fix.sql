-- =============================================================================
-- Phase 25: Reallocation Latent Bug Fix
-- Description: Fixes latent bug in reallocate_cancelled_delivery_fees where
-- it tried to update the non-existent `grand_total` column on orders.
-- =============================================================================
