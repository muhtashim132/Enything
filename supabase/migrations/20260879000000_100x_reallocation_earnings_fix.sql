-- =============================================================================
-- Phase 24: Reallocation Rider Earnings Fix
-- Description: Removes the flawed `COALESCE(rider_earnings, 0) = 0` check
-- from reallocate_cancelled_delivery_fees. Since rider_earnings is projected
-- at checkout, it is never 0, breaking the reallocation algorithm.
-- Double-reallocation is already prevented by zeroing out delivery_charges.
-- =============================================================================
