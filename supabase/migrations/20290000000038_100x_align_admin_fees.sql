-- =============================================================================
-- Migration: 100x Align Admin Fees
-- Description:
--   1. Aligns all SQL defaults with the Dart frontend defaults (e.g. platform_fee = 20.0)
--      to prevent "Spoofing Detected" errors on fresh environments.
-- =============================================================================
