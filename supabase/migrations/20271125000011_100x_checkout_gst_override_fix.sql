-- =============================================================================
-- Migration: 20271125000010_100x_checkout_order_id_items_fix.sql
-- Description: ADDITIVE ONLY — CREATE OR REPLACE FUNCTION only.
--              Fixes the order items shop_id bug (P0001: Shop order must
--              contain at least one valid item) by correctly mapping the 
--              items payload using order_id instead of shop_id.
-- =============================================================================
