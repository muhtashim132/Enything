-- =============================================================================
-- Phase 31: Absolute Fortress v3 (Concurrency & Inactive Bypass)
-- Description: Locks coupons FOR UPDATE to prevent double-spend race conditions 
-- and explicitly rejects payloads targeting `is_active = false` shops to prevent 
-- Ghost Order insertions.
-- =============================================================================
