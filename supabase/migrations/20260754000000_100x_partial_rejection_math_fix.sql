-- =============================================================================
-- Migration: Fix Partial Rejection Grand Total Math
-- Description:
-- 1. Updates `reallocate_cancelled_delivery_fees` to correctly subtract `coupon_discount`
--    from the `grand_total` of the cancelled order during fee zeroing, preventing artificially
...
BEGIN
    ...
    LOOP
        ...
        SET delivery_charges       = 0,
            ...
            delivery_discount      = 0,
            gst_delivery           = 0,
            -- BUG-FIX: Include coupon_discount in the grand_total calculation
