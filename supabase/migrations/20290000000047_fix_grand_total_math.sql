-- 20290000000047_fix_grand_total_math.sql
-- BUG FIX: A previous migration removed small_cart_fee, heavy_order_fee, and multi_shop_surcharge
-- from the v_new_grand calculation because it incorrectly assumed delivery_charges contained them.
-- Since they are stored separately, they MUST be included in the grand total calculation.
...
BEGIN
    ...
    LOOP
        ...
        LOOP
            ...
            -- 100x FIX: Restore the fees into the grand total because delivery_charges does NOT contain them anymore!
