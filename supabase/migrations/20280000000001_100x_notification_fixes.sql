-- Migration: 20280000000001_100x_notification_fixes.sql
-- Description: Fixes customer notifications for multiple shops accepting, removes the manual "Pay Now" notification, and fixes iOS buzz.
