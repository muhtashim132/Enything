-- =============================================================================
-- Phase 27: Stress Test Fortress (Pixel Overloading & Cascading Failure Protection)
-- Description: Limits JSON bombs, adds coupon spoofing math validation, enforces
-- delivery charge floor, and stops max int quantity exploits.
-- =============================================================================
