-- =============================================================================
-- Migration: 20290000000052_fix_accept_admin_invitation_role_id.sql
-- Description:
--   1. Fixes accept_admin_invitation to use role_id from admin_invitations
--      instead of non-existent role_name column.
--   2. Fixes admin_users check constraint and admin_level.
--   3. Ensures RLS policy on admin_users allows bootstrapping/admin management.
-- =============================================================================

-- Ensure role_name column exists as optional fallback on admin_invitations
ALTER TABLE public.admin_invitations ADD COLUMN IF NOT EXISTS role_name TEXT;

-- Drop obsolete or restrictive admin_level check constraint
