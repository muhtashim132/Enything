-- =============================================================================
-- Migration: 20290000000086_100x_soft_delete_rpc_enforcement.sql
-- =============================================================================
-- Description:
--   ADDITIVE ONLY:
--   Enhances public.place_orders_transaction() to explicitly verify that products
--   have is_deleted = false when acquiring row locks during checkout.
--   Preserves 100% of all existing business logic, fee structures, tax calculations,
--   and multi-shop rules without any destructive changes.
-- =============================================================================
